...
public final class DynamicHub implements JavaKind.FormatWithToString, AnnotatedElement, java.lang.reflect.Type, GenericDeclaration, Serializable,
    ...
    /**
     * Permitted subclasses for this class. This value is created during the image build by
     * caching {@link Class#getPermittedSubclasses()} value for usage in
     * {@link DynamicHub#getPermittedSubclasses()}
     */
